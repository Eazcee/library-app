...
<head>
    <meta charset="UTF-8">
    <title>Test</title>
    <meta name="description" content="The small with powerful features">
    ...
    <style {csp-style-nonce}>
        ...
        *:focus {
            background-color: rgba(113, 168, 131, 0.2);
            outline: none;
        }
        html, body {
        ...
        header {
            background-color: rgb(31, 110, 189);
            padding: .4rem 0 0;
        }
        .menu {
            padding: .4rem 2rem;
        ...
        header li.menu-item a:focus {
            background-color: rgba(20, 221, 120, 0.2);
            color: rgb(20, 221, 30);
        }
        header .logo {
            float: left;
